...
<body>
    ...
    <input type="text" oninput="suggest2(this)"/> <input type="button" value="검색" />
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=aa52c36db4a468eff71df54deb2aa302"></script>
    <script>
...
//            var url = 'http://apihub.daum.net/local/v2/search/kakao/keyword.json?query=%EC%B9%B4%EC%B9%B4%EC%98%A4%ED%94%84%EB%A0%8C%EC%A6%88&x=127.0628310224993&y=37.514322572335935&radius=20000&appkey=f12f233215abce1a637fa26816e3c195';
            ...
            $.ajax({
                url: url,
                headers: {
                    "Authorization": "KakaoAK aa52c36db4a468eff71df54deb2aa302"  
                },
